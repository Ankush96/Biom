...
mex -f mexopts_intel10.bat -output svmtrain.dll svmtrain.c svm.cpp svm_model_matlab.c


mex -DopenMP -f mexopts_intel10.bat -output svmtrain.dll svmtrain.c svm.cpp svm_model_matlab.c

(add a environnement variable OMP_NUM_THREADS = 2 if dualcore, add /Qopenmp in compilation flags)
